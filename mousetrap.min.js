/* mousetrap v1.4.3 craig.is/killing/mice */
...
d.length;++e)d[e].seq?d[e].level==g&&(f=!0,b[d[e].seq]=1,w(d[e].callback,c,d[e].combo)):f||w(d[e].callback,c,d[e].combo);d="keypress"==c.type&&a===H;c.type!=u||(v(a)||d)||t(b);H=f&&"keydown"==c.type?a:!1}};window.Mousetrap=n;"function"===typeof define&&define.amd&&define(n)})();
